...
### Community 6 - "App.tsx"
Cohesion: 0.06
Nodes (65): react, App(), handleDownload(), handleSuccessClose(), AppHeader(), BackgroundEffects, CardGlowEffects, Footer() (+57 more)
...
## Knowledge Gaps
- **1473 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+1468 more)
